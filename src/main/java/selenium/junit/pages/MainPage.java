...
public class MainPage extends BasePage {
    private final By centralBanner = By.xpath("//div[contains(@class,'owl-carousel main-slider')]");
    private final By priorityLogo = By.xpath("//a[@title='Приоритет 2030']");
    private final By advancedEngineeringSchoolLogo = By.xpath("//a[@title='Передовая инженерная школа']");
    private final By pgupsResources = By.xpath("//span[text()='Ресурсы ПГУПС']");
    private final By forStudents = By.xpath("//a[text()='Студентам']/ancestor::div[@class='dropdown']/a");
    private final By forApplicants = By.xpath("//a[text()='Абитуриентам']/ancestor::div[@class='dropdown']/a");
    private final By educationModule = By.xpath("//a[text()='Образование']/ancestor::li[@data-for-menu='/education/']");
    private final By contactsModule = By.xpath("//a[text()='Контакты']/ancestor::li[@data-for-menu='/contacts/']");
    private final By scienceModule = By.xpath("//a[text()='Наука']/ancestor::li[@data-for-menu='/science/']");
    private final By admissionCommittee = By.xpath("//a[text()='Приемная комиссия']/ancestor::li[contains(@data-for-menu,'priem')]");
    private final By cultureAndSportsModule = By.xpath("//a[text()='Культура и спорт']/ancestor::li[@data-for-menu='/culture-and-sport/']");
    private final By schedule = By.xpath("//span[text()='ПГУПС.Расписание']/..");
    private final By dormitories = By.xpath("//a[text()='Общежития']");
    private final By admissionsCommitteeWebsite = By.xpath("//a[text()='Сайт приемной комиссии']");
    private final By admissionsCommitteeWebsiteFromModule = By.xpath("//div[@data-menu='/priem_2020/']//a[text()='Сайт приемной комиссии']");
    private final By directionsAndSpecialties = By.xpath("//a[text()='Направления и специальности']");
    private final By facultyContacts = By.xpath("//a[text()='Контакты факультетов']");
    private final By scientificConferences = By.xpath("//a[text()='Научные конференции']");
    private final By pgupsMuseum = By.xpath("//div[@data-menu='/culture-and-sport/']//a[text()='Музей ПГУПС']");
    ...
    public MainPage priorityLogoClick() {
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(priorityLogo)));
        return this;
    }

    @Step("Выбор раздела 'ПИШ'")
    public MainPage advancedEngineeringSchoolLogoClick() {
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(advancedEngineeringSchoolLogo)));
        return this;
    }

    private MainPage pgupsResourcesClick() {
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(pgupsResources)));
        return this;
    }
    ...
    public MainPage scheduleClick() {
        pgupsResourcesClick();
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(schedule)));
        return this;
    }

    @Step("Выбор раздела 'Общежития'")
    public MainPage dormitoriesClick() {
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(forStudents)));
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(dormitories)));
        return this;
    }

    @Step("Выбор раздела 'Сайт приемной комиссии'")
    public MainPage admissionsCommitteeWebsiteClick() {
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(forApplicants)));
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(admissionsCommitteeWebsite)));
        return this;
    }

    @Step("Выбор раздела 'Направления и специальности'")
    public MainPage directionsAndSpecialtiesClick() {
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(educationModule)));
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(directionsAndSpecialties)));
        return this;
    }

    @Step("Выбор раздела 'Контакты факультетов'")
    public MainPage facultyContactsClick() {
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(contactsModule)));
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(facultyContacts)));
        return this;
    }

    @Step("Выбор раздела 'Научные конференции'")
    public MainPage scientificConferencesClick() {
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(scienceModule)));
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(scientificConferences)));
        return this;
    }

    @Step("Выбор раздела 'Приемная комиссия' через верхнее меню")
    public MainPage admissionCommitteeModuleClick() {
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(admissionCommittee)));
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(admissionsCommitteeWebsiteFromModule)));
        return this;
    }

    @Step("Выбор раздела 'Музей ПГУПС'")
    public MainPage pgupsMuseumClick() {
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(cultureAndSportsModule)));
        jsClick(webDriverWait.until(ExpectedConditions.elementToBeClickable(pgupsMuseum)));
        return this;
    }
}
