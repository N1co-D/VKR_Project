...
public class PgupsSeleniumTestngTest extends BaseTest {

    @Description("Проверка отражения названия ожидаемой пары в соответствии с её порядком и днем недели")
    @Test(dataProvider = "test1TestData", dataProviderClass = PgupsDataSeleniumJunit.class)
    ...
    @Test(dataProvider = "test2TestData", dataProviderClass = PgupsDataSeleniumJunit.class)
    ...
    @Test(dataProvider = "test3TestData", dataProviderClass = PgupsDataSeleniumJunit.class)
    ...
    @Test(dataProvider = "test4TestData", dataProviderClass = PgupsDataSeleniumJunit.class)
    ...
    @Test(dataProvider = "test5TestData", dataProviderClass = PgupsDataSeleniumJunit.class)
    ...
    @Test(dataProvider = "test6TestData", dataProviderClass = PgupsDataSeleniumJunit.class)
    ...
    @Test(dataProvider = "test7TestData", dataProviderClass = PgupsDataSeleniumJunit.class)
    ...
    @Test(dataProvider = "test8TestData", dataProviderClass = PgupsDataSeleniumJunit.class)
    ...
    @Test(dataProvider = "test9TestData", dataProviderClass = PgupsDataSeleniumJunit.class)
    ...
    @Test(dataProvider = "test10TestData", dataProviderClass = PgupsDataSeleniumJunit.class)
